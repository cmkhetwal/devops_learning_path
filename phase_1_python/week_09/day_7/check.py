#!/usr/bin/env python3
"""
Auto-checker for Week 9, Day 7: Quiz Day
"""
import subprocess
import sys
...
def run_exercise():
    result = subprocess.run(
        ...
        cwd="/home/cmk/python/devops-python-path/week_09/day_7",
        timeout=30
    )
    return result.stdout + result.stderr, result.returncode

def extract_answers(output):
    """Extract answers from output like 'Q1: b    (answered)'."""
    answers = {}
...
def main():
    print("=" * 50)
    print("  CHECKING: Week 9 Quiz - Docker & Containers")
    print("=" * 50)
